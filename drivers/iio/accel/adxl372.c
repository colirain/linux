...
#define ADXL372_DRV_NAME		"adxl372"
 ...
 */
static const int adxl372_uscale = 958241;
		...
		bool enable)
{
	...
	th_reg_low_val = ((threshold / 100) << 5) | (referenced << 1) | enable;
...
static int adxl372_probe(struct spi_device *spi)
{
	...
	indio_dev->name = ADXL372_DRV_NAME;
